...
<body>
    <header>
        <div class="logo-area">
        <a href="/index.html"><img src="img/k-logo.svg" alt="" class="site-logo"></a>
        </div>
    </header>
    <div class="page-container transition-fade" id="swup">
      <div id="contact-me" class="content-area">
          <div class="container">
              <div class="parallax-container">
                <div class="section-header parallax-element" data-depth="0.2">
                  <h1 class="transition-expand"><span>Contact Me</span></h1>
                </div>
              </div>
                ...
                <div class="parallax-element" data-depth="0.5">
                    <div class="transition-slide-right">
                        <form method="post" action="contact.php">
                            ...
                            <span class="selected success"><?php echo $messageSuccess;?></span>
                        </form>
                    </div>
                  <p class="transition-slide-right"><a class="purple-link with-background" href="/portfolio.html"><nobr>&lArr; Back to my work</nobr></a><span class="selected"> / </span><a class="purple-link with-background" href="/index.html"><nobr>Homepage &rArr; </nobr></a></p>
                </div>
              </div>
